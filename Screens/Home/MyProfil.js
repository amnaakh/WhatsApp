  ...
  return (
    ...
    >
      ...
      <View style={layout.innerContainer}>
        ...
        <TouchableHighlight
          onPress={handleSave}
          style={[layout.button, styles.saveButton, { backgroundColor: isModified ? colors.buttonColor : "#D7BDE2" }]} // Désactivation du bouton si non modifié
